...
var evenlyThree = List[Int]()                     //> evenlyThree  : List[Int] = List()
                    
for (elem <- list) if (elem % 3 == 0) evenlyThree = evenlyThree ++ List(elem)
println(evenlyThree)                              //> List(3, 6, 9, 12, 15, 18)

val filtered = list.filter(_ % 3 == 0)            //> filtered  : List[Int] = List(3, 6, 9, 12, 15, 18)
