object LearningScala3 {
  ...
  println(toUpperCase("hey there!"))              //> HEY THERE!
  println(toUpperCase("this works!"))             //> THIS WORKS!
  
  def transformString(x: String, f: String => String) : String = {
  	f(x)
  }                                               //> transformString: (x: String, f: String => String)String
  
  transformString("hey there", x => x.toUpperCase)//> res3: String = HEY THERE
  transformString("it works!", x => x.toUpperCase)//> res4: String = IT WORKS!
